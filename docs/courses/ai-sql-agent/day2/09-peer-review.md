...
!!! tip "🧭 이 시간을 이렇게 읽으세요 (비개발자용)"
    - **한 줄 핵심**: 어제 작성한 프로젝트 제안서를 동료들과 교차 검토하며 스키마와 질문 난이도를 다듬는 시간입니다.
    - **꼭 이해**: 좋은 제안서의 3요소 — (1) 명확한 도메인, (2) AI 가 풀 수 있는 난이도 분포, (3) 정답 SQL 까지 제시된 질문 10개.
    - **지금은 몰라도 OK**: 동료 피드백을 모두 수용해야 한다는 부담. 핵심만 골라 반영하면 됩니다.
